...
- 详解各个对象：
  ...
  3. **Statement：执行sql的对象**<a id=Statement>Statement</a>
...
5. **PreparedStatement：执行sql的对象**<a id=PreparedStatement>PreparedStatement</a>
...
**`PreparedStatement`实现可以避免sql注入的问题**
