...
<body>
      <ol>
         ...
         <li>
            <br/>
            <ul>
               <li><a href="cookieServlet?action=defaultCookie" target="target">Cookie的默认存活时间（会话）</a></li>
               <li><a href="cookieServlet?action=deleteCookie" target="target">Cookie立即删除</a></li>
               <li><a href="cookieServlet?action=keepCookie" target="target">Cookie存活60秒（1分钟）</a></li>
            </ul>
         </li>
