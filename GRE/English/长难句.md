...
1. 一般用法：if引导的条件状语从句；
   ...
   - If I was a gog last night,I could sleep in bed.(条件状语从句)
2. 如果把一个正常的条件状语从句变成虚拟语气呢？
   - 只需要把已经写好的句子的时态变成过去式就行了:
   - 虚拟语气：If you were a tear in my eyes, I would never shed itr㘝.
   - 虚拟语气：If I had been a gog last night,I could have slept in bed.
...
- She talked with me last nignt as if she had been my mother.
...
- 把一句话写成一般疑问句的形式就是倒装，也就是给一句话提个助动词放在句首就是倒装。
  ...
  - 2.so，nor neighter放在句首表示承前的肯定或否定使用倒装；
    - I can speak Janpanese, so can I .
    - I can't speak Janpanese, nor can I .
